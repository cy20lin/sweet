  ...
  foreach(__package IN LISTS ARGN)
    ...
    foreach(__suffix LIBRARIES LIBRARY LIBS)
      if (NOT "${${__package}_${__suffix}}" STREQUAL "")
        # [NOTE] CMP0023
        _sweet_target_add("${__target}" LIBRARIES PRIVATE ${${__package}_${__suffix}})
        break()
      endif()
    endforeach()
    foreach(__suffix INCLUDES INCLUDE_DIR INCLUDE_DIRS)
      if (NOT "${${__package}_${__suffix}}" STREQUAL "")
        _sweet_target_add("${target}" INCLUDES PRIVATE ${${__package}_${__suffix}})
        break()
      endif()
    endforeach()
    foreach(__suffix DEFINITIONS)
      if (NOT "${${__package}_${__suffix}}" STREQUAL "")
        _sweet_target_add("${target}" DEFINITIONS ${${__package}_${__suffix}})
        break()
      endif()
    endforeach()
  endforeach()
